...
def strassenR(A, B):
    ...
    if n <= 8:
        ...
        new_size = n // 2
        a11 = [[0 for j in range(new_size)] for i in range(new_size)]
        a12 = [[0 for j in range(new_size)] for i in range(new_size)]
        a21 = [[0 for j in range(new_size)] for i in range(new_size)]
        a22 = [[0 for j in range(new_size)] for i in range(new_size)]

        b11 = [[0 for j in range(new_size)] for i in range(new_size)]
        b12 = [[0 for j in range(new_size)] for i in range(new_size)]
        b21 = [[0 for j in range(new_size)] for i in range(new_size)]
        b22 = [[0 for j in range(new_size)] for i in range(new_size)]

        aResult = [[0 for j in range(new_size)] for i in range(new_size)]
        bResult = [[0 for j in range(new_size)] for i in range(new_size)]
...
if __name__ == "__main__":
    ...
    C = strassen(A, B)
    print(C)
    assert np.allclose(C, A @ B, 10**(-10))
