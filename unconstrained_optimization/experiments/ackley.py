...
nadam_ = nadam(fn = ackley_fn, fn_grad=fn_grad)
amsgrad_ = amsgrad(fn = ackley_fn, fn_grad=fn_grad)
nag_ = nag(fn = ackley_fn, fn_grad=fn_grad)
RMSprop_ = RMSprop(fn = ackley_fn, fn_grad=fn_grad)
