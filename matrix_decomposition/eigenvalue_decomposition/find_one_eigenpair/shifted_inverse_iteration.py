...
def shifted_inverse_iteration(matrix, mu):
    ...
    eigenvalue = np.dot(eigenvector.T, matrix * eigenvector) / np.dot(eigenvector.T, eigenvector)
    
    return eigenvector.reshape(-1,), eigenvalue.item(), iters
...
if __name__ == "__main__":
    ...
    eigenvector, eigenvalue, iters = shifted_inverse_iteration(matrix, mu)
